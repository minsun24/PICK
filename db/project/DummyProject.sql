-- 1. MEMBER 테이블 (회원 20명)
INSERT INTO member
(NAME, age, ihidnum, phone_number, email, password, nickname, status, reported_count, user_grant) VALUES
...
-- 2. TECHNOLOGY_CATEGORY 테이블
INSERT INTO TECHNOLOGY_CATEGORY (id, name, is_deleted, ref_technology_category_id) VALUES
                                                                                       (1, '백엔드', 'N', NULL),
                                                                                       (2, '프론트엔드', 'N', NULL),
                                                                                       (3, '풀스택', 'N', 1),
                                                                                       (4, 'AI', 'N', NULL);

-- 3. PROJECT_ROOM 테이블 (5개 프로젝트)
INSERT INTO PROJECT_ROOM (name, content, is_finished, duration_time, maximum_participant, session_code, start_date, end_date, technology_category_id) VALUES
...
-- 4. PARTICIPANT 테이블 (각 프로젝트에 참가자들 배정)
INSERT INTO PARTICIPANT (is_manager, project_room_id, member_id) VALUES
...
-- 5. MEMBER_REVIEW 테이블 (10개 후기)
INSERT INTO MEMBER_REVIEW (rate, content, reviewer_id, reviewee_id) VALUES
                                                                        (5, '매우 훌륭합니다.', 1, 2),
                                                                        (4, '성실한 팀원이에요.', 2, 3),
                                                                        (5, '의사소통이 원활해요.', 6, 7),
...
-- 6. PROJECT_REVIEW 테이블 (각 프로젝트에 대한 후기)
INSERT INTO PROJECT_REVIEW (reviewer_id, content, project_room_id) VALUES
                                                                       (1, '좋은 프로젝트였습니다.', 1),
                                                                       (6, '정말 유익했어요.', 2),
...
-- 7. PROJECT_MEETING 테이블 (각 프로젝트에 회의록)
INSERT INTO PROJECT_MEETING (project_room_id, name, content, author, upload_time, update_time) VALUES
...
-- 8. PROJECT_MEETING_IMAGE 테이블 (각 회의록에 이미지)
INSERT INTO PROJECT_MEETING_IMAGE (img_path, renamed, is_thumbnail, meeting_id) VALUES
